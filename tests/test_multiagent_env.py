...
# ---------------------------------------------------------------------------
# Test 1: observation size matches the constants (Phase 8: 314 with flame channel)
# ---------------------------------------------------------------------------

def test_agent_obs_size() -> None:
    """Obs vector must be exactly OBS_TOTAL_SIZE (314 in Phase 8) floats.
    ...
    """
    assert OBS_RESOURCE_GRID_SIZE == 125, f"Expected 125, got {OBS_RESOURCE_GRID_SIZE}"
    assert OBS_AGENT_GRID_SIZE == 125, f"Expected 125, got {OBS_AGENT_GRID_SIZE}"
    ...
    assert OBS_TOTAL_SIZE == 314, f"Expected 314, got {OBS_TOTAL_SIZE}"
