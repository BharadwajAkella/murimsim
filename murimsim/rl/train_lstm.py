...
def main() -> None:
    ...
    checkpoint_dir = Path(lstm_cfg.get("checkpoint_dir", "checkpoints/limbic_lstm_v1"))
    ...
    final_path = checkpoint_dir / "limbic_lstm_v1_final.zip"
